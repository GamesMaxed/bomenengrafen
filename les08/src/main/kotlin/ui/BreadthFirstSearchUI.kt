...
fun main(args: Array<String>) {
    ...
    val data = arrayOf(intArrayOf(0, 1, 0, 1, 0, 0, 0), intArrayOf(0, 0, 1, 0, 0, 0, 0), intArrayOf(1, 0, 0, 1, 1, 0, 0), intArrayOf(0, 0, 0, 0, 1, 1, 0), intArrayOf(0, 1, 0, 0, 0, 0, 1), intArrayOf(0, 0, 0, 0, 0, 0, 1), intArrayOf(0, 0, 0, 0, 0, 0, 0)) // nabijheidsmatrix van graf  uit  figuur  1.5  van  cursus
    val bfs = Graph(data)

    var start = 1
    var destination = 7
    // deelresultaat afdrukken
    println(bfs.geefAncestors(start, destination))
    // eindresultaat
